...
from messagetypes.messages import AnalysisData, TranscriptionData, Message
...
def count(name: str) -> None:
    ...
    logger.info(f"Message count in queue 'default': {count}")
    queue_service.close()
...
def generate(count: int, name: str) -> None:
    logger.info(f"Generating {count} messages in queue 'default'")
